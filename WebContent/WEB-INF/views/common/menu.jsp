...
<ul class="nav flex-column">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam07/ContentController">상태유지 - Session(서버측 저장, 해당 클라이언트만 사용)</a>
		</h6>
	</li>
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a class="text-white" href="/servletjsp/exam08/ContentController">상태유지 - ServletContext(서버측 저장, 모든 클라이언트 사용)</a>
		</h6>
	</li>
